...
.factory('Chats', function() {
  ...
  var chats = [{
    ...
    like:false,
    circleTime:"7分钟前",
    circleImg:["img/bg2.jpg","img/miao.jpg","img/bg.jpg","img/ionic.png","img/ben.png"],
    comment:[{
      name:'ben',
      content:'good job'
    },{
  ...
  return {
    ...
    top:function(chat){
      var item=chats.splice(chats.indexOf(chat), 1);
      console.log(item[0]);
      chats.unshift(item[0]);
    }
  };
})
